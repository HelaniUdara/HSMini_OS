...
[SEGMENT .data]
	strWelcomeMsg		db	"Welcome to HSMini_OS", 0x00

				

	wel1 db '************ WELCOME TO HSMINI_OS *************', 0x00 

	wel2 db ' Based on Josh  -  by Dr.Mohan Raj Dhanagopal', 0x00

	wel3 db ' HSMini_OS  :-  Extended Josh  -  Version 1.1', 0x00

	wel4 db ' Modified by :   Helani Udara  -  SE/2019/022', 0x00

	wel5 db ' To display the Help Menu type    -->    help', 0x00
	...
	h_ver  db ' Version  --> To display OS version', 0x00
	h_info db ' Info     --> To display Hardware Infomation', 0x00
	h_exit db ' Exit     --> To Exit', 0x00


	strPrompt		db	"HSMini_OS>>", 0x00
	cmdMaxLen		db	255			;maximum length of commands

	strOsName		db	"HSMini_OS", 0x00	;OS details
